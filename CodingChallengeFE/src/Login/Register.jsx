...
const Register = () => {
    ...
    const handleRegister = async (e) => {
        ...
        try {
            const response = await axios.post('https://localhost:7208/api/Aauth/customer-register', {
                username,
                email,
                password,
            });
                ...
                <div className="flex-1 flex justify-center items-center px-4 py-8 lg:py-0 bg-white shadow-lg">
                    <div className="max-w-md w-full">
                        ...
                        <p className="text-sm text-center mt-6 text-spacecadet font-semibold">
                            Already have an account? <Link to="/login" className="text-utorange hover:underline font-bold">Log in here</Link>
                        </p>
                    </div>
                </div>
            </div>
